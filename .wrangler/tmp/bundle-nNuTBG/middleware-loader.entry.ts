...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/vincaslt/remix-cf-demo-app/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/vincaslt/remix-cf-demo-app/.wrangler/tmp/bundle-nNuTBG/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/vincaslt/remix-cf-demo-app/.wrangler/tmp/bundle-nNuTBG/middleware-insertion-facade.js";
